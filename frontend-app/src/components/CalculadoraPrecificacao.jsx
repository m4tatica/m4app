            ...
            {resultado ? (
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Imposto de Venda:</span>
                    <span className="font-medium">
                      {resultado.impostoVendaPercent.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}%
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Preço de Venda Final:</span>
                    <span className="font-medium">
                      R$ {resultado.precoVendaFinal.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Margem Percentual:</span>
                    <span className="font-medium">
                      {resultado.margemPercentual.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}%
                    </span>
                  </div>
                </div>
              </div>
